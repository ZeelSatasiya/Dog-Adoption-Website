...
<div id="page" class="container">
    ...
    $query = "SELECT * FROM booked_dogs";
     // -- WHERE u_agency='$a_userid'";  
    $result = mysqli_query($conn, $query);  
    while($row = mysqli_fetch_array($result))  
    {  
          $r1=$row['u_userid'];
          $query1="SELECT * from customer where u_userid='$r1'";
          ...
          $query2="SELECT * from dog where d_userid='$r2'";
          ...
          $row2 = mysqli_fetch_array($result2);
           ...
           echo '  
                  ...
                  <div class="gallery">
                          ...
                          <img src="data:image/jpg;base64,'.base64_encode($row2['d_photo'] ).'"  width="900" height="600" class="img-thumnail" />'; 
                echo '          <div class="desc">
                          dog name: '.$row2['d_name'].'<br>
                          booked by :
                          userid of the person: '.$r1.'<br>
                          name of the person: '.$row1['u_name'].'<br> 
                          </div> 
                  </div>
             ';
               // }           
           ...
           //                <img src="data:image/jpg;base64,'.base64_encode($row2['d_photo'] ).'"  width="900" height="600" class="img-thumnail" /> 
           //                <div class="desc">dog name: '.$row2['d_name'].'<br>
           //                booked by :
           //                userid of the person: '.$row['u_userid'].'<br>
           //                name of the person:'.$row1['u_name'].'<br>  </div> 
           //        </div>
           //   ';	
           // }

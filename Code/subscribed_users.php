...
<div id="page" class="container">
    ...
    $query="SELECT * from customer where u_userid in (SELECT u_userid FROM subscriber where a_userid='$a_userid')";

    // $query = "SELECT * FROM subscriber where a_userid='$a_userid'";
//     -- WHERE u_agency='$a_userid'";  
    ...
    {  
          ...
          // if($row1=mysqli_fetch_array($result1)){
            // $r2=$row['a_userid'];
          // $query2="SELECT * from agency where a_userid='$r2'";
          ...
          // if($row2 = mysqli_fetch_array($result2)){
           ...
           echo '  
                  <div><h3><b>
                          ...
                          <div class="desc">
                          Customer Name: '.$row['u_name'].'<br>
                          Customer id: '.$row['u_userid'].'<br>
                          </div> </b></h3>
                  </div><br><br>
             ';
             // }  
